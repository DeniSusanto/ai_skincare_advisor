...
def extract_patches(imagefile, dimension_dict, face_loc_dict, croppedFaces_Dir):
    ...
    if face_detected:
        ...
        key_name = imageName+'_landmark_fh'
        ...
        key_name = imageName+'_landmark_chin'
        ...
        if right_face:
            ...
            key_name = imageName+'_landmark_rc'
        ...
        if left_face:
            ...
            key_name = imageName+'_landmark_lc'
